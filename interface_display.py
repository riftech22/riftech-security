...
class SecuritySystemWindow(QMainWindow):
    ...
    def _setup_ui(self):
        self.setWindowTitle("RIFTECH SECURITY")
        ...
        self.person_label = QLabel("PERSONS: 0")
        ...
        ctrl_group = QGroupBox("<< SYSTEM CONTROLS >>")
        ...
        det_group = QGroupBox("<< DETECTION CONFIG >>")
        ...
        zone_group = QGroupBox("<< SECURITY ZONES >>")
        ...
        self.draw_zone_btn = QPushButton("[*] DRAW")
        ...
        self.clear_zones_btn = QPushButton("[X] CLEAR")
        ...
        feat_group = QGroupBox("<< ACTIVE FEATURES >>")
        feat_layout = QVBoxLayout(feat_group)

        self.skeleton_cb = QCheckBox("[*] SKELETON TRACKING")
    ...
    def _process_frame(self):
        ...
        self.person_label.setText(f"PERSONS: {self.person_count}")
    ...
    def _toggle_draw_mode(self, checked):
        ...
        self.draw_zone_btn.setText("[DONE]" if checked else "[DRAW]")
